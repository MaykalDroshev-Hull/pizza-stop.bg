      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="prose prose-invert max-w-none space-y-6 text-text-secondary">
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li><strong>Зона 1 (Център на Ловеч):</strong> Доставка 2 €, време за доставка 30-45 минути</li>
              <li><strong>Зона 2 (Разширена зона):</strong> Доставка 5 €, време за доставка 45-60 минути</li>
              <li>Безплатна доставка в централната зона при поръчки над 25 €</li>
          ...
          <section className="mb-8">
            ...
            <p>
              ...
              Моля, свържете се с нас възможно най-скоро на телефон 068 670 070.
            </p>
          </section>
