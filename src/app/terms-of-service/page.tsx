        ...
        <div className="prose prose-invert max-w-none space-y-6 text-text-secondary">
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>Минималната стойност за поръчка за доставка е 10 €.</li>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li><strong>Зона 1 (Център на Ловеч):</strong> Доставка 3 €., време за доставка 30-45 минути</li>
              <li><strong>Зона 2 (Разширена зона):</strong> Доставка 7 €., време за доставка 45-60 минути</li>
