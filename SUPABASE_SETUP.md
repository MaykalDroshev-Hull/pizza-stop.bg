...
-- Enhanced LkOrderProduct table with complete order details
CREATE TABLE public."LkOrderProduct" (
  "LkOrderProductID" bigint GENERATED BY DEFAULT AS IDENTITY NOT NULL,
  ...
  "Addons" text, -- JSON string of selected addons
  "Comment" text,
  CONSTRAINT LkOrderProduct_pkey PRIMARY KEY ("LkOrderProductID"),
  CONSTRAINT fk_lkorderproduct_order FOREIGN KEY ("OrderID") REFERENCES "Order" ("OrderID"),
  CONSTRAINT fk_lkorderproduct_product FOREIGN KEY ("ProductID") REFERENCES "Product" ("ProductID")
